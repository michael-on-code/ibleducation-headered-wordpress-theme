...
jQuery(function ($) {
    ...
    $(document.body)
        .bind('country_to_state_changing', function (event, country, wrapper) {
            ...
            var $postcodefield = thisform.find('#mailing_postcode_field'),
                $cityfield = thisform.find('#mailing_city_field'),
                $statefield = thisform.find('#mailing_state_field');
            ...
            var fieldsets = $(
                '.woocommerce-mailing-fields__field-wrapper'
            );
